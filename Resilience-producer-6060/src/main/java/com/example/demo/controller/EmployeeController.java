...
public class EmployeeController {
	...
	//2. 當 empId 是合法, 但是因為網路或資料庫忙碌, 而發生問題
	...
	//6. 利用 TimeLimiter 來處理錯誤, 目的是限制方法執行的最大時間，防止長時間未響應的請求拖垮系統。
